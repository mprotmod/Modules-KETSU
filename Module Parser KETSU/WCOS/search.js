...
var animes = document.getElementById('blog').querySelectorAll('div.cerceve');
var dataArray = [];
for (var i = 0; i < animes.length; i++) {
    var anime = animes[i];
    var name = anime.querySelector('a').getAttribute('title');
    var image = baseUrl + anime.querySelector('img').src;
    image = new ModuleRequest(image, 'get', emptyKeyValue, null);
    var link = baseUrl + anime.querySelector('a').href;
    ...
    var searchObj = new Data(image, name, type+' '+voice, 'field1', 'field2', 'field3', 'field4', false, link);
